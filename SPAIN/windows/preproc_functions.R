...
data_INE_ccaa <-
  function(cod_ine = 1:19,
           ...
           file_pop = "pop_ccaa_INE.csv", save_local = TRUE) {
    ...
    # ICU places    
    url_ICU_places_ccaa = "ccaa_camas_uci_2017.csv"
    raw_data <- read.csv(url_ICU_places_ccaa, fileEncoding = "UTF-8")
...
data_isciii_ccaa <-
  function(data_INE_ccaa, url_isciii_data =
    ...
    url_isciii_data = "ccaa_covid19_datos_isciii.csv"
