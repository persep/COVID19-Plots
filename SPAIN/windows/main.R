# Save main.R and preproc_functions.R with encoding ISO-8859-1
...
regions <- c("Andalucía", "Aragón", "Asturias", "Baleares", "Canarias",
             "Castilla La Mancha", "Cantabria", "Castilla y León", "Cataluña",
             "Galicia", "C. Valenciana", "Madrid", "Murcia", "País Vasco",
             "La Rioja")
...
# admin_ccaa: cumulative of admissions (ICU included) data
# ICU_ccaa: cumulative of ICU data
...
var_ccaa <- c("cum_cases", "cum_recov", "cum_deaths", "daily_cases",
              "daily_recov", "daily_deaths", "actives", "vel_cases",
              "fatality", "mortality")
fig_data_ccaa <-
